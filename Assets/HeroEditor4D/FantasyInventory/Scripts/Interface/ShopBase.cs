...
namespace Assets.HeroEditor4D.FantasyInventory.Scripts.Interface
{
    ...
    public class ShopBase : ItemWorkspace
    {
        ...
        public int GetPrice(Item item) // Modify this function to fit your needs!
        {
            ...
            if (trader && CurrencyId != "Gold")
            {
                return item.Params.FindProperty(PropertyId.CustomPrice).ValueInt * Amount;
            }
        ...
        public void Buy()
        {
            ...
            if (GetCurrency(Bag, CurrencyId) < price)
            {
                ...
                TapHeroes.Scripts.Interface.Popup.Instance.ShowMessage(SimpleLocalization.LocalizationManager.Localize("Common.NoFunds"), CurrencyId, NoMoney);
